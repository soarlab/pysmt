...
class HRPrinter(TreeWalker):
    ...
    def walk_st(self, formula):
        self.write('ST ')
        
    def walk_wp(self, formula):
        self.write('WP ')
        
    def walk_ru(self, formula):
        self.write('RU ')
        
    def walk_rd(self, formula):
        self.write('RD ')
    ...
    def fxp_op(self, signed, op, formula):
    ...
    def walk_ufxp_add(self, formula):
        self.fxp_op(False, 'add', formula)
        
    def walk_sfxp_add(self, formula):
        self.fxp_op(True, 'add', formula)

    def walk_ufxp_sub(self, formula):
       self.fxp_op(False, 'sub', formula)
       
    def walk_sfxp_sub(self, formula):
       self.fxp_op(True, 'sub', formula)

    def walk_ufxp_mul(self, formula):
       self.fxp_op(False, 'mul', formula)
       
    def walk_sfxp_mul(self, formula):
       self.fxp_op(True, 'mul', formula)

    def walk_ufxp_div(self, formula):
       self.fxp_op(False, 'div', formula)
       
    def walk_sfxp_div(self, formula):
       self.fxp_op(True, 'div', formula)

    def walk_ufxp_lt(self, formula):
       self.fxp_op(False, 'lt', formula)

    def walk_sfxp_lt(self, formula):
       self.fxp_op(True, 'lt', formula)
       
    def walk_ufxp_le(self, formula):
       self.fxp_op(False, 'le', formula)

    def walk_sfxp_le(self, formula):
       self.fxp_op(True, 'le', formula)
